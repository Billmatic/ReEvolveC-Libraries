...
namespace ReEvolveCSharpLibrary.ErrorHandling
{
    ...
    public enum ThrottledResourceType
    {
        ...
        /// <summary>
        /// Corresponds to an unknown resource type in the event when the actual resource cannot be 
    ...
    public enum ThrottlingMode
    {
        ...
        /// <summary>
        /// Corresponds to "Reject Update / Insert" throttling mode whereby SQL statements such as INSERT,
        /// UPDATE, CREATE TABLE and CREATE INDEX are rejected.
        /// </summary>
        RejectUpdateInsert = 1,

        /// <summary>
        /// Corresponds to "Reject All Writes" throttling mode whereby SQL statements such as INSERT, UPDATE,
        /// DELETE, CREATE, DROP are rejected.
        /// </summary>
        RejectAllWrites = 2,
        ...
        /// <summary>
        /// Corresponds to an unknown throttling mode whereby throttling mode cannot be determined with 
        /// certainty.
        /// </summary>
        Unknown = -1
    }
    ...
    public enum ThrottlingType
    {
        ...
        /// <summary>
        /// Corresponds to a Soft throttling type. Soft throttling is applied when machine resources such as,
        /// CPU, IO, storage, and worker threads exceed predefined safety thresholds despite the load 
        /// balancer’s best efforts. 
        /// </summary>
        Soft = 1,

        /// <summary>
        /// Corresponds to a Hard throttling type. Hard throttling is applied when the machine is out of 
        /// resources, for example storage space. With hard throttling, no new connections are allowed to 
        /// the databases hosted on the machine until resources are freed up.
        /// </summary>
        Hard = 2,

        /// <summary>
        /// Corresponds to an unknown throttling type in the event when the throttling type cannot be 
        /// determined with certainty.
        /// </summary>
        Unknown = 3
    }
    ...
    /// <summary>
    /// Implements an object holding the decoded reason code returned from SQL Azure when encountering
    ...
    public class ThrottlingCondition
    {
        ...
        /// <summary>
        /// Provides a compiled regular expression used for extracting the reason code from the error 
        /// message.
        /// </summary>
        private static readonly Regex _sqlErrorCodeRegEx =
            new Regex(@"Code:\s*(\d+)", RegexOptions.IgnoreCase | RegexOptions.Compiled);

        /// <summary>
        /// Maintains a collection of key-value pairs where a key is resource type and a value is the type of
        /// throttling applied to the given resource type.
        /// </summary>
        ...
        /// <summary>
        /// Gets an unknown throttling condition in the event the actual throttling condition cannot be 
        /// determined.
        /// </summary>
        /// <value>The unknown throttling condition.</value>
        public static ThrottlingCondition Unknown
        {
            get
            {
                ThrottlingCondition unknownCondition = new ThrottlingCondition
                {
                    ThrottlingMode = ThrottlingMode.Unknown
                };

                unknownCondition._throttledResources.Add(Tuple.Create(
                    ThrottledResourceType.Unknown, ThrottlingType.Unknown));
        ...
        /// </summary>
        /// <value>true if CPU throttling was reported; otherwise false.</value>
        public bool IsThrottledOnCpu
        {
            get
            {
                return _throttledResources
                    .Where(x => x.Item1 == ThrottledResourceType.Cpu)
                    .Count() > 0;
            }
        }
        ...
        /// </summary>
        /// <value>true if database size throttling was reported; otherwise false.</value>
        public bool IsThrottledOnDatabaseSize
        {
            get
            {
                return _throttledResources
                    .Where(x => x.Item1 == ThrottledResourceType.DatabaseSize)
                    .Count() > 0;
            }
        }
        ...
        /// </summary>
        /// <value>true if data read activity throttling was reported; otherwise false.</value>
        public bool IsThrottledOnDataRead
        {
            get
            {
                return _throttledResources
                    .Where(x => x.Item1 == ThrottledResourceType.DataReadIoDelay)
                    .Count() > 0;
            }
        }
        ...
        /// </summary>
        /// <value>true if physical data file space throttling was reported; otherwise false.</value>
        public bool IsThrottledOnDataSpace
        {
            get
            {
                return _throttledResources
                    .Where(x => x.Item1 == ThrottledResourceType.PhysicalDatabaseSpace)
                    .Count() > 0;
            }
        }
        ...
        /// </summary>
        /// <value>true if physical log space throttling was reported; otherwise false.</value>
        public bool IsThrottledOnLogSpace
        {
            get
            {
                return _throttledResources
                    .Where(x => x.Item1 == ThrottledResourceType.PhysicalLogSpace)
                    .Count() > 0;
            }
        }
        ...
        /// </summary>
        /// <value>true if transaction activity throttling was reported; otherwise false.</value>
        public bool IsThrottledOnLogWrite
        {
            get
            {
                return _throttledResources
                    .Where(x => x.Item1 == ThrottledResourceType.LogWriteIoDelay)
                    .Count() > 0;
            }
        }
        ...
        /// </summary>
        /// <value>true if concurrent requests throttling was reported; otherwise false.</value>
        public bool IsThrottledOnWorkerThreads
        {
            get
            {
                return _throttledResources
                    .Where(x => x.Item1 == ThrottledResourceType.WorkerThreads)
                    .Count() > 0;
            }
        }
        ...
        /// </summary>
        /// <value>true if throttling conditions were not determined with certainty; otherwise false.</value>
        ...
        /// </summary>
        /// <value>Throttled resources.</value>
        ...
        /// </summary>
        /// <param name="error">The <see cref="System.Data.SqlClient.SqlError"/> object containing 
        /// information relevant to a warning or error returned by SQL Server.</param>
        ...
        public static ThrottlingCondition FromError(SqlError error)
        {
            if (error != null)
            {
                var match = _sqlErrorCodeRegEx.Match(error.Message);
                int reasonCode;
        ...
        /// </summary>
        /// <param name="ex">The <see cref="System.Data.SqlClient.SqlException"/> object containing
        /// information relevant to an error returned by SQL Server when encountering throttling 
        /// conditions.</param>
        /// <returns>An instance of the object holding the decoded reason codes returned from SQL Azure upon 
        /// encountering throttling conditions.</returns>
        ...
        /// <summary>
        /// Returns a textual representation the current ThrottlingCondition object including the information
        /// held with respect to throttled resources.
        /// </summary>
